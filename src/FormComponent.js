      ...
      <div className="ui container">
        ...
        <div className="ui placeholder segment">
          <div
            ...
            style={{
              display: this.state.stage == 'SIGNEDIN' ? 'block' : 'none',
            }}
          >
            <div className="column">
              <div className="ui form">
                <p className="ui center aligned segment">
                  cognito username : {this.state.cognito_username}
                </p>
                <div className="field">
                ...
                <br />
                <div className="ui blue submit button" onClick={this.signOut}>
                  SignOut
                </div>
              </div>
            </div>
          ...
          <div
            ...
            style={{
              display: this.state.stage == 'SIGNEDIN' ? 'none' : 'block',
            }}
          >
            <div className="column">
              <div
                className="ui form"
                style={{
                  display: this.state.stage == 'VERIFYING' ? 'block' : 'none',
                }}
              >
                <div className="field">
                ...
                <div className="ui blue submit button" onClick={this.confirm}>
                  Confirm Account
                </div>
                <p className="ui center aligned segment">
              ...
              <div
                className="ui form"
                style={{
                  display: this.state.stage == 'FORGOT' ? 'block' : 'none',
                }}
              >
                <div className="field">
                  <label>Email</label>
                ...
                <div className="ui blue submit button" onClick={this.sendCode}>
                  {' '}
                  Send Email
                </div>
                <br />
                ...
                <div
                  className="ui blue submit button"
                  onClick={this.changePasswordForgot}
                >
                  {' '}
                  Change Password
                </div>
              ...
              <div
                ...
                style={{
                  display:
                    this.state.stage == 'SIGNIN' || this.state.stage == 'SIGNUP'
                      ? 'block'
                      : 'none',
                }}
              >
                <div
                  className="field"
                  style={{
                    display: this.state.stage == 'SIGNUP' ? 'block' : 'none',
                  }}
                >
                  <label>Name</label>
                  <div className="ui left icon input">
                ...
                <div
                  ...
                  onClick={this.signIn}
                  style={{
                    display: this.state.stage == 'SIGNIN' ? 'block' : 'none',
                  }}
                >
                  Sign In
                </div>
                ...
                >
                  ...
                  <a href="#" onClick={this.gotoSignUp}>
                    Sign Up
                  </a>
                </p>
                <p
                ...
                >
                  <a href="#" onClick={this.gotoPasswordRest}>
            ...
            <div className="middle aligned column">
              <div className="App">
                ...
                >
                  Continue with Google <i class="google plus icon"></i>
                </button>
              </div>
            </div>
          </div>
